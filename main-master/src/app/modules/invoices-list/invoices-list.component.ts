...
export class InvoicesListComponent extends FormComponent {
  ...
  public linkRoute: string = 'invoices';
...
/*    this.scripts = [
    ...
    this.links = [
      ...
      { name: 'invoices', link: 'invoices-list' }
    ];*/
    this.selectedDate = 2;
  ...
  public initUi() {
    ...
    this.ui = {
      ...
      placeholder: 'search ...',
      results: 'Invoice',
      resultsPlural: 'Invoices',
      filter: 'filter',
      resultsWarning: 'No invoice matches the specified search terms',
    }
  }
