...
export class FormListComponent extends FormComponent {
  ...
  public initForm() {
    ...
    this.positionDisplayed = this.formList.positionDisplayed;
    this.numberDisplayed = this.formList.numberDisplayed;
    this.paginationDisplayed = this.formList.paginationDisplayed;
    this.scripts = [
    ...
    this.selectModelRow.options = [
      ...
      { value: 6, label: '1000 rows' },
      { value: 7, label: 'Infinite' },
    ];
  ...
  public initUi() {
    ...
    this.ui = {
      ...
      placeholder: 'search ...',
      results: 'City',
      resultsPlural: 'Cities',
      filter: 'filter',
      resultsWarning: 'No city matches the specified search terms',
    }
  }
  ...
  public onChangeSelectRow(event: any) {
    ...
    if (this.selectedRow == 6) { perPage = 1000; }
